...
public class TextNodeSelectedMenuContributionItem extends CommandContributionItem {

	public TextNodeSelectedMenuContributionItem(
	...
	public boolean isEnabled() {
		...
		if (selection != null && selection instanceof IStructuredSelection) {
			...
			/*
			 * return true if we have a TextNode selected
			 */
			return ((obj != null) && (obj instanceof TextNode));
		}
		return false;
	}
