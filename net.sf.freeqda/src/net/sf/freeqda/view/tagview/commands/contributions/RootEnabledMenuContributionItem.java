...
public class RootEnabledMenuContributionItem extends CommandContributionItem {

	public RootEnabledMenuContributionItem(
	...
	public boolean isEnabled() {
		...
		if (selection != null && selection instanceof IStructuredSelection) {
			 ...
			 */
			return ((obj != null) && (obj instanceof TagNode));
		}
		return false;
	}
