...
public interface DocumentSelectionManipulateTagsListener extends EventListener {
	
	public void DocumentSelectionTagAdded(DocumentSelectionAddTagEvent event);

	public void DocumentSelectionRemoveAllTags(DocumentSelectionRemoveAllTagsEvent event);
