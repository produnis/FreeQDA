...
public interface ITagModificationListener {
	
	public abstract void NodeCreated(TagNodeCreatedEvent evt);
	public abstract void NodeDeleted(TagNodeDeletedEvent evt);
	public abstract void TagActivated(TagActivatedEvent evt);
