 ...
 *       &lt;attribute name="CategoryID" type="{http://www.w3.org/2001/XMLSchema}IDREF" />
...
public class TextType {
    ...
    protected String id;
    @XmlAttribute(name = "CategoryID", namespace = "http://sf.net.freeqda/FQDAProject")
    @XmlIDREF
    @XmlSchemaType(name = "IDREF")
    protected Object categoryID;
    @XmlAttribute(name = "Activated", namespace = "http://sf.net.freeqda/FQDAProject")
