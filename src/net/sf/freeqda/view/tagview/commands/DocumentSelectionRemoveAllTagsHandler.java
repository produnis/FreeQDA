...
public class DocumentSelectionRemoveAllTagsHandler extends AbstractHandler {
...
//			FQDADocumentType document = provider.getActiveDocument();
			...
			//FIXME DocumentRegistry: removeAllTagsFromRange 
//			REGISTRY.removeAllTagsFromRange(textNode, selectionRange.x + styledText.getCharacterOffset(), selectionRange.y);
			DocumentRegistry.getInstance().removeCodeFromRange(textNode, null /* null := all tags */, selectionRange.x + styledText.getCharacterOffset(), selectionRange.y);
